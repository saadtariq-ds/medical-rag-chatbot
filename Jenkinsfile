        ...
        stage('Clone GitHub Repo') {
            steps {
                script {
                    ...
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'medical-rag-token', url: 'https://github.com/saadtariq-ds/medical-rag-chatbot.git']])
                }
            }
        }
